...
TRACK_INTERVAL = 2           # Main tracking loop interval
SCREENSHOT_INTERVAL = 10     # OCR screenshot interval  
AUDIO_INTERVAL = 5           # Audio recording interval
WEBCAM_INTERVAL = 30         # Webcam attention check interval
USER_ALLOW_WEBCAM = False    # Webcam permission toggle
