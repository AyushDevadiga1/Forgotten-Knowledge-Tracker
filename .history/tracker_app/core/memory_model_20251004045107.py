...
def forgetting_curve(t, s=1.25):
    """
    Compute probability of recall using Ebbinghaus forgetting curve.
    t: time since last review in hours
    s: memory strength parameter (default 1.25)
    """
    return math.exp(-t / s)


def log_forgetting_curve(concept, last_seen_time, observed_usage=1, memory_strength=1.25):
    """
    ...
    predicted_recall = forgetting_curve(t_hours, s=memory_strength)
