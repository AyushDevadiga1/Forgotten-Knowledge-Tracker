...
# For backward compatibility with tracker.py imports
def extract_features(*args, **kwargs):
    """
    Dummy/extract_features wrapper for tracker.py compatibility.
    Calls predict_intent asynchronously and returns a placeholder or structured dict.
    """
    import asyncio
    return asyncio.run(predict_intent(*args, **kwargs))
