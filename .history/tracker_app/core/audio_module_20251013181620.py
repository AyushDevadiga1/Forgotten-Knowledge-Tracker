...
# These are just wrappers to the AudioModule class for backward compatibility

_audio_module_instance = AudioModule()

def record_audio() -> np.ndarray:
    """Module-level function for compatibility with tracker.py"""
    return _audio_module_instance.record_audio()

def extract_features(audio: np.ndarray) -> np.ndarray:
    """Module-level function for compatibility with tracker.py"""
    return _audio_module_instance.extract_features(audio)
