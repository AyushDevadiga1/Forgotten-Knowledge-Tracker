...
def extract_features(audio):
    """Compute MFCC + energy features safely (14 features total)."""
    try:
        ...
        # Extract MFCC features (13 features)
        ...
        # Extract energy (1 feature) - TOTAL: 14 features
        energy = np.mean(audio**2)
        
        features = np.concatenate([mfccs_mean, [energy]])
        return features
        
    except Exception as e:
        print(f"Audio feature extraction failed: {e}")
        return np.zeros(14)  # 13 MFCC + energy
