...
def log_multi_modal(window, ocr_keywords, audio_label, attention_score, interaction_rate, intent_label, intent_confidence):
    ...
    # -----------------------------
    # Prepare OCR data for JSON storage
    # -----------------------------
...
def track_loop():
    ...
    while True:
        try:
            ...
            if not isinstance(latest_interaction, int):
                latest_interaction = 0
            ...
            if ocr_counter >= SCREENSHOT_INTERVAL:
                ...
                # Safe conversion to native types
                safe_ocr = {}
                ...
                if latest_ocr:
                    ...
                    try:
                        ...
                        print(f"Adding concepts failed: {e}")
                else:
                ...
                try:
                    ...
                    for concept, info in latest_ocr.items():
                        ...
                        mem_score *= min(1.0, kw_score + 0.5)          # importance
                        mem_score *= min(1.5, 1 + 0.05 * (count - 1)) # repetition
                    ...
                    print(f"Memory modeling failed: {e}")
            ...
            try:
                intent_data = predict_intent_live(
                    latest_ocr, latest_audio, latest_attention, latest_interaction
                )
            except Exception as e:
            ...
            try:
                ...
                print(f"Multi-modal logging failed: {e}")
            ...
            if save_counter >= SAVE_INTERVAL:
                try:
                    ...
                    print(f"Saving knowledge graph failed: {e}")
                save_counter = 0
