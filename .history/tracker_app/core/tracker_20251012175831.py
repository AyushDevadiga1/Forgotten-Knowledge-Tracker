...
from core.knowledge_graph import add_concepts, get_graph, add_edges, save_knowledge_graph
    ...
    try:
        while True:
            try:
                ...
                try:
                    add_edges(_latest_ocr, _latest_audio, _latest_intent.get("intent_label", "unknown"))
                except Exception:
                    pass
