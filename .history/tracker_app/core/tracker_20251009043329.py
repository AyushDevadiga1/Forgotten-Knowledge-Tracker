            ...
            try:
                ...
                if webcam_counter >= WEBCAM_INTERVAL:
                    if USER_ALLOW_WEBCAM:
                        try:
                            ...
                            latest_attention = None  # mark as invalid
                    else:
                        latest_attention = None  # webcam disabled
                    webcam_counter = 0
                ...
                for concept, info in latest_ocr.items():
                    try:
                        ...
                        att_score = int(latest_attention) if latest_attention is not None else None

                        mem_score = compute_memory_score(
                            last_review, lambda_val, intent_conf, att_score, audio_conf
                        )
                        ...
                        # Only notify if webcam is available or attention ignored
