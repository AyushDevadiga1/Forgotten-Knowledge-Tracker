...
if intent_clf is not None and intent_label_map is not None:
        try:
            ...
            print(f"DEBUG: Classifier prediction - {pred}")  # Add this line
            ...
            print(f"DEBUG: Final intent - {label}, confidence: {confidence}")  # Add this
                return {"intent_label": str(label), "confidence": confidence}
