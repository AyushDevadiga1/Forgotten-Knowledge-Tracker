...
- Fully async-ready with asyncio.to_thread for heavy blocking operations
"""
...
async def ocr_pipeline(roi: Optional[Tuple[int,int,int,int]] = None) -> Dict[str, Any]:
    """
    Async OCR pipeline: capture -> preprocess -> OCR -> keyword extraction -> filter important
