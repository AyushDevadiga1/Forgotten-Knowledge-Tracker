# ==========================================================
# core/face_detection_module.py | IEEE-ready Async
# ==========================================================
"""
Face Detection Module (IEEE-ready Async)
----------------------------------------
...
- Compatible with FusionPipeline & SessionManager
"""
...
if not logger.handlers:
    handler = logging.FileHandler("logs/face_detection.log")
...
class FaceDetector:
    def __init__(self, camera_index: int = 0, resize_factor: float = 0.5, max_faces: int = 5):
        ...
        self.cap_frame: Optional[any] = None
    ...
    def get_latest_frame(self):
        """Return latest raw frame captured by webcam."""
