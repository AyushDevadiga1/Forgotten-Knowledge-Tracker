# ==========================================================
# core/memory_model.py (IEEE v3.0)
# ==========================================================
"""
Memory Model Module (IEEE v3.0)
--------------------------------
- Computes memory scores using multi-modal signals & Ebbinghaus curve.
- Supports batch updates and integrates with the knowledge graph.
- Schedules next review adaptively.
- Logs all events via centralized multi_modal_logs table.
...
def compute_memory_score(
    ...
    """
    Compute memory score for a single concept.
    Optionally updates knowledge_graph node if `concept` is provided.
    """
    ...
    # Update knowledge graph if concept provided
...
def compute_memory_scores_batch(
    ...
    """
    Compute memory scores for multiple concepts efficiently.
    Returns mapping: concept -> memory_score
    """
    results = {}
...
def log_forgetting_curve(
    ...
    try:
        ...
        logger.error(f"[MemoryModel] Logging failed for '{concept}': {log_e}")
