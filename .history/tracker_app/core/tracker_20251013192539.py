        ...
        while not stop_event.is_set():
            ...
            try:
                ...
                if audio_counter >= AUDIO_INTERVAL:
                    ...
                    latest_data['audio_label'] = audio_label
                    latest_data['audio_confidence'] = audio_conf
                    audio_counter = 0
                    print(f"Audio: {audio_label} (conf: {audio_conf:.2f})")
...
# Replace this part inside track_loop():

# Webcam processing
webcam_counter += TRACK_INTERVAL
if webcam_counter >= WEBCAM_INTERVAL and USER_ALLOW_WEBCAM:
    try:
        # Use unified webcam module
        from core.webcam_module_unified import webcam_pipeline
        ...
        print(f"Webcam: Attention {attention_score:.1f}, Faces: {face_count}, Status: {webcam_result.get('status')}")
        webcam_counter = 0
    except Exception as e:
        ...
        webcam_counter = 0
                ...
                if save_counter >= 300:  # Save every 5 minutes
