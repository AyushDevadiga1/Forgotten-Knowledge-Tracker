...
# ==========================================================
"""
Face Detection Module (IEEE-Ready Async v2)
-------------------------------------------
- Thread-safe asynchronous webcam capture
- Dlib-based frontal face detection
- Normalized attention scoring
- Safe fallback if webcam unavailable
- Structured output for tracker integration
"""
...
class FaceDetector:
    ...
    def _capture_loop(self):
        if self.cap is None:
            try:
                ...
                logger.warning(f"Failed to initialize webcam: {e}")
                self.latest_attention = None
                return
    ...
    def stop_async(self):
        """Stop asynchronous capture and release resources."""
