...
def fetch_memory_decay():
    conn = sqlite3.connect(DB_PATH)
    # Use correct column names: keyword -> concept, last_seen_ts -> timestamp, predicted_recall -> memory_score
    query = """
...
if df_decay.empty:
    ...
    fig.update_layout(legend_title_text="Concept")
