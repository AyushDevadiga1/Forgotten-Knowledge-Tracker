# dashboard/dashboard_full_updated.py
import sys
import os
import sqlite3
...
st.markdown("""
    ...
    .css-ffhzg2 {color: #FFFFFF;}
    .stDataFrame {background-color:#2C2C3C;}
    </style>
""", unsafe_allow_html=True)

st.title("🌌 Forgotten Knowledge Tracker Dashboard")
st.markdown("Monitor learning sessions, memory scores, knowledge graph, upcoming reminders, and more.")
...
node_max_size = st.sidebar.slider("Max Node Size", 200, 2000, 700)
...
with tabs[0]:
    ...
    if G.nodes:
        ...
        st.dataframe(df_mem.style.background_gradient(subset=["Memory Score"], cmap="plasma"))
