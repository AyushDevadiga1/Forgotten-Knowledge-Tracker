...
# -----------------------------
# Remaining Tabs (Sessions, Memory Decay, Predicted Forgetting, Multi-Modal, Reminders)
# -----------------------------
# Keep your existing logic for these tabs, but replace duplicate fetch_decay calls
# with the single @st.cache_data decorated fetch_decay() defined above.
# Also ensure all plotting uses robust conversion to numeric/datetime and handles empty dfs.
