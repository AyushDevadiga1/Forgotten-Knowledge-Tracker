# ==========================================================
# dashboard.py | Full FKT Tracker Dashboard
# ==========================================================
...
# -----------------------------
st.set_page_config(page_title="🔮 FKT Dashboard", layout="wide")
st.title("🔮 Forgotten Knowledge Tracker Dashboard")
st.markdown("Visualize your learning sessions, memory decay, knowledge graph, upcoming reminders, and more.")
...
# ==========================================================
# TAB 4: Sessions Timeline & Heatmap
# ==========================================================
