...
# -----------------------------
# Fetch Memory Decay Data (Corrected)
# -----------------------------
@st.cache_data(ttl=300)
...
# -----------------------------
# Remaining tabs (Knowledge Graph, Sessions, Memory Decay, Predicted Forgetting, Multi-Modal Logs, Upcoming Reminders)
# Use same code as before but reference corrected `fetch_decay` function
# -----------------------------
# You can reuse your previous code here with no SQL errors
