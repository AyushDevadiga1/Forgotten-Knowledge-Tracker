...
# ==========================================================
"""
FKT Dashboard — LitePro Edition + System Health Panel
-----------------------------------------------------
...
def get_system_health():
    try:
        ...
        conn_status = "✅ Connected" if os.path.exists(DB_PATH) else "❌ Missing"
...
h1.metric("🧠 CPU", health["CPU Usage"])
h2.metric("💾 Memory", health["Memory Usage"])
h3.metric("📂 DB Size", health["DB Size"])
h4.metric("🔗 DB Status", health["DB Status"])
h5.metric("⏱️ Uptime", health["Tracker Uptime"])
...
# ==========================================================
# ⏱️ Productivity Timeline
# ==========================================================
st.markdown("### 📆 Productivity Timeline")
...
# ==========================================================
# 🕸️ Knowledge Graph (2D)
# ==========================================================
if show_graph:
    st.markdown("### 🧩 Knowledge Graph (Semantic Links)")
    try:
        sync_db_to_graph()
        G = get_graph()
        if not G.nodes:
