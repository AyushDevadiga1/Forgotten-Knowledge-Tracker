...
# ----------------------------- #
# Continue for other tabs: Memory Decay, Predicted Forgetting, Logs, Reminders
# ----------------------------- #
# For brevity, same pattern: wrap DB fetches & plotting in try-except, handle empty DataFrames, replace NaN with defaults.

# Key Enhancements:
# - DB failures handled
# - Empty or NaN DataFrames handled
# - NaN-proof plotting for memory scores & graph
# - Safe timeline & heatmap
# - Safe selection of top concepts
# - Safe knowledge graph plotting
# - Defaults if graph empty
# - Safe handling of webcam/audio toggles
