...
selected_tab_index = st.sidebar.slider(
    "Go to Tab", min_value=0, max_value=len(tab_names)-1, value=0, step=1, format="%d - "+tab_names[0]
)

# Map the slider value to tab name dynamically
selected_tab_name = tab_names[selected_tab_index]
st.sidebar.markdown(f"**Selected Tab:** {selected_tab_name}")

# ----------------------------- Tabs with Conditional Display -----------------------------
# Instead of using st.tabs, we show only the tab matching the slider index
if selected_tab_index == 0:
    with st.expander("Overview", expanded=True):
        # Paste all code for Overview Tab here
        pass

elif selected_tab_index == 1:
    with st.expander("Knowledge Graph (3D)", expanded=True):
        # Paste all code for Knowledge Graph Tab here
        pass

elif selected_tab_index == 2:
    with st.expander("Sessions", expanded=True):
        # Paste Sessions Tab code
        pass

elif selected_tab_index == 3:
    with st.expander("Memory Decay", expanded=True):
        # Paste Memory Decay Tab code
        pass

elif selected_tab_index == 4:
    with st.expander("Predicted Forgetting", expanded=True):
        # Paste Predicted Forgetting Tab code
        pass

elif selected_tab_index == 5:
    with st.expander("Multi-Modal Logs", expanded=True):
        # Paste Multi-Modal Logs code
        pass

elif selected_tab_index == 6:
    with st.expander("Upcoming Reminders", expanded=True):
        # Paste Upcoming Reminders code
        pass

elif selected_tab_index == 7:
    with st.expander("OCR Insights", expanded=True):
        # Paste OCR Insights code
        pass

elif selected_tab_index == 8:
    with st.expander("Audio / Intent Analysis", expanded=True):
        # Paste Audio / Intent Analysis code
        pass

elif selected_tab_index == 9:
    with st.expander("Visual Attention Stats", expanded=True):
        # Paste Visual Attention Stats code
        pass

elif selected_tab_index == 10:
    with st.expander("Performance Insights", expanded=True):
        # Paste Performance Insights code
        pass

elif selected_tab_index == 11:
    with st.expander("System Health", expanded=True):
        # Paste System Health code
        pass
