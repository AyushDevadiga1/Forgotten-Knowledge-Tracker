...
with tabs[0]:
    ...
    if df_s.empty:
        ...
        # Top apps and keywords
        top_apps = df_s.groupby("app_name")["duration_min"].sum().nlargest(10)
        top_keywords = df_s['audio_label'].value_counts().nlargest(10)
        ...
        # Daily study trend (simple line chart)
