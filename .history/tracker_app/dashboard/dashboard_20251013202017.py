...
with tabs[2]:
    ...
    if not df_keywords.empty:
        ...
        x_nodes = [pos3[n][0] for n in G3.nodes]
        y_nodes = [pos3[n][1] for n in G3.nodes]
        z_nodes = [pos3[n][2] for n in G3.nodes]

        edge_x, edge_y, edge_z = [], [], []
        for e in G3.edges:
            edge_x += [pos3[e[0]][0], pos3[e[1]][0], None]
            edge_y += [pos3[e[0]][1], pos3[e[1]][1], None]
            edge_z += [pos3[e[0]][2], pos3[e[1]][2], None]
        ...
        st.info("No keywords available for 3D mapping.")

# -----------------------------
# Remaining Tabs (Sessions, Memory Decay, Predicted Forgetting, Multi-Modal Logs, Upcoming Reminders)
# -----------------------------
# [Keep your existing implementations for tabs 3-7 as they already handle edge cases]
# -----------------------------
