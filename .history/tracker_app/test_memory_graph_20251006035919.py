...
def test_get_text_embedding_v2_shape():
    emb = ocr.get_text_embedding_v2("Sample text")
    assert isinstance(emb, np.ndarray)
    assert emb.shape[0] == 384

def test_get_text_embedding_v2_empty():
    emb = ocr.get_text_embedding_v2("")
